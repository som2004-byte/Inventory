...
const tools: ChatCompletionTool[] = [
  {
    ...
    function: {
      name: "list_low_stock",
      description:
        "List inventory items at or below their reorder level (need restocking). Use for low stock, reorder, out of stock questions.",
      parameters: {
        type: "object",
        properties: {
...
}): Promise<{ reply: string; usedLlm: true; model: string; usedTools: string[] }> {
